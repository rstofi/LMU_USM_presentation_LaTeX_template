...
%===  Set theme ===
\usetheme{LMU} %using Dingo theme
...
\author[Krist\'of Rozgonyi]{\textbf{Krist\'of Rozgonyi{\Large \inst{1}}}} %Note that the inst signs fontsize have to be set here to match with author size 
\date[today]{\today}
